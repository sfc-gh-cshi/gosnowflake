...
cd $TOPDIR
go test -timeout 30m -tags=sfdebug -race $COVFLAGS -v -run TestOpenWithConfig # -stderrthreshold=INFO -vmodule=*=2 or -log_dir=$TOPDIR -vmodule=connection=2,driver=2
